...
describe("validating putting testcase", function () {
  ...
  it.skip("Verifying what's to focus on statitics", { tags: ['@smoke'] }, function () {
    ...
    puttingPage.puttscoringzones_bottom_3().then(function (ele) {
      expect(utils.extractnumber(focus)).to.eq(Number(utils.extractnumber(ele.text()).toFixed(0)));
