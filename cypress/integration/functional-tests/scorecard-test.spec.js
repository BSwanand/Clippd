...
// import { roundInsightsPage } from "../../support/pageObjects/RoundInsight_Page";
...
describe("Validating round insights", () => {
  ...
  it(
    ...
    () => {
      cy.xpath(
        "//body/div/div[@aria-hidden='false']/main/div/div/div/div/div/div[@data-testid='loading-content']/div/div/div/div/div/div/div[1]/div[2]/div[2]/div[1]"
      ).click();
      roundInsightsPage
        .hole()
        .invoke("text")
