...
describe('Coach specific Tests', () => {
    ...
    it('Validate Continue button behaviour after filling info as Coach Page-2', () => {
    ...
    it('Validate back button behaviour after filling info as Coach Page-2', () => {
        utils.clickOn(registrationPage.continueBtn);
        registrationPage.describe_yourself_as('Coach');
        // utils.clickOn(registrationPage.selectCountryDropDown);
        // registrationPage.Where_are_you_based('Germany');
    ...
    it('Validating if progress bar loads upto 20% Page-2', () => {
        utils.clickOn(registrationPage.continueBtn);
        registrationPage.describe_yourself_as('Coach');
        // utils.clickOn(registrationPage.selectCountryDropDown);
        // registrationPage.Where_are_you_based('Germany');
    ...
    it('Validate performance tech options Page-2', () => {
        utils.clickOn(registrationPage.continueBtn);
        registrationPage.describe_yourself_as('Coach');
        // utils.clickOn(registrationPage.selectCountryDropDown);
    ...
    it('Validating required filed missing related message Page-2', () => {
        utils.clickOn(registrationPage.continueBtn);
        registrationPage.describe_yourself_as('Coach');
        // utils.clickOn(registrationPage.selectCountryDropDown);
        // registrationPage.Where_are_you_based('Germany');
    ...
    it('Validating if progress bar loads upto 40% Page-3', () => {
        utils.clickOn(registrationPage.continueBtn);
        registrationPage.describe_yourself_as('Coach');
        // utils.clickOn(registrationPage.selectCountryDropDown);
        // registrationPage.Where_are_you_based('France');
    ...
    it('verifying if progress bar loads upto 60% Page-4', () => {
        utils.clickOn(registrationPage.continueBtn);
        registrationPage.describe_yourself_as('Coach');
        // utils.clickOn(registrationPage.selectCountryDropDown);
        // registrationPage.Where_are_you_based('France');
    ...
    it('Verifying performance tech options Page-5', () => {
        utils.clickOn(registrationPage.continueBtn);
        registrationPage.describe_yourself_as('Coach');
        // utils.clickOn(registrationPage.selectCountryDropDown);
        // registrationPage.Where_are_you_based('France');
    ...
    it('Verifying page objects Page-6', () => {
        utils.clickOn(registrationPage.continueBtn);
        registrationPage.describe_yourself_as('Coach');
        // utils.clickOn(registrationPage.selectCountryDropDown);
        // registrationPage.Where_are_you_based('France');
