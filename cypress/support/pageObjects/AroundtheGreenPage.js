...
const argplayerqualitysection = "//div[@class='border-gray-700 flex flex-col md:w-auto ṭext-white pl-5 py-4 md:py-0 md:border-r lg:h-full lg:px-4 xl:px-6']"
...
const faiwayroughsand = "//*[contains(@class,'border-gray-700 border-t')]"
...
class AroundtheGreenPage {
	...
	ARGplayerqualitysection() {
		return cy.xpath(argplayerqualitysection, { timeout: 8000 })
	}
	PGATourTopsection() {
